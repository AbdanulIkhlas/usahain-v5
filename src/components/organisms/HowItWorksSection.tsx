...
const steps = [
  {
    ...
    colorClass:
      "text-primary-600 bg-primary-100 dark:text-primary-400 dark:bg-primary-900/40",
  },
  {
    icon: <Target size={32} />,
    title: "2. Planning",
    ...
    colorClass:
      "text-secondary-600 bg-secondary-100 dark:text-secondary-400 dark:bg-secondary-900/40",
  },
  {
    ...
    colorClass:
      "text-accent-600 bg-accent-100 dark:text-accent-400 dark:bg-accent-900/40",
  },
  {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <motion.div
              key={index}
              className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary-500/10 hover:border-primary-200 dark:hover:border-primary-700 group"
